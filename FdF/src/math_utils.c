...
static void	apply_one(t_point *point, t_matrix mat)
{
	...
	tmp = *point;
	point->x = tmp.x * mat.r1c1 + tmp.y * mat.r2c1 + tmp.z * mat.r3c1;
	point->y = tmp.x * mat.r1c2 + tmp.y * mat.r2c2 + tmp.z * mat.r3c2;
	point->z = tmp.x * mat.r1c3 + tmp.y * mat.r2c3 + tmp.z * mat.r3c3;
}
